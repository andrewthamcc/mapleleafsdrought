...
export const events: Record<string, TimeEvent> = {
  '1967-05-02': {
  ...
  '2025-07-01': {
    title: 'Marner goes to Vegas',
    description: 'Core four no more',
    position: 70,
  },
  '2026-01-03': {
    title: 'Matthews becomes all time leading goal scorer',
  },
  '2026-03-02': {
    title: 'Leafs mathematically eliminated',
    description: 'No playoffs for the first time in the Matthews era',
    position: 30,
  },
  '2026-06-27': {
    title: 'Gavin McKenna drafted',
    position: 80
  },
}
